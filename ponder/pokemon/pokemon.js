...
document.querySelector('#ability').addEventListener('click', function() {
    if (document.querySelector('#ability').src == "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/132.png") {
        document.querySelector('#ditto').setAttribute('src', ditto.transform());
    } else {
